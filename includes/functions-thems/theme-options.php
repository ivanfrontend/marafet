...
array(
      ...
      //       array(
      //   'id'          => 'footer',
      //   'title'       => 'настройка подвала сайта'
      // ),
       
    ),
    'settings'        => array(

      // Настроек Общие настройки сайта
     
          array(
        'id'          => 'setincs_priloder_tab',
        'label'       => 'Настройка прилодера',
        'desc'        => '',
        'type'        => 'tab',
        'section'     => 'all_setings_site',
      ),


          array(
        'id'          => 'setincs_priloder_text',
        'label'       => 'Текст для прилодера',
        'desc'        => 'Прилодер это: то что вы видите на сайте до полной его загрузки.',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'all_setings_site',
      ),
        ...
        'section'     => 'all_setings_site',
          ...
          array(
        'id'          => 'text_logo_bottom',
        'label'       => 'Маленький текст под логотипам',
        'desc'        => '',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'all_setings_site',
          ...
          // Конец настроек Общие настройки сайта
          ...
          array(
        'id'          => 'sontakt_list_phone_namber',
        'label'       => 'Добавить номер телефона',
        'desc'        => '',
        'std'         => '',
        'type'        => 'list-item',
        'section'     => 'setings_contacts_section',
        'settings'    => array( 
 
          array(
            'id'          => 'add_phone_namber',
            'label'       => 'Ведите номер телефона',
            'desc'        => '',
            'type'        => 'text',
          ),
        ...
        'section'     => 'setings_contacts_section',
          ...
          array(
        'id'          => 'login_viber',
        'label'       => 'Укажите номер телефона viber',
        'desc'        => '',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'setings_contacts_section',
        ...
        'section'     => 'setings_contacts_section',
          ...
          // Конец настройки контактов сайта



      //                   array(
      //   'id'          => 'setings_one_block',
      //   'label'       => 'Настройки первого блока',
      //   'desc'        => '',
      //   'type'        => 'tab',
      //   'section'     => 'header',
      // ), 
      ...
      //                   array(
      //   'id'          => 'text_description_tab',
      //   'label'       => 'настройки блока контакты',
      //   'desc'        => '',
      //   'type'        => 'tab',
      //   'section'     => 'footer',
      // ),
      // array(
      //   'id'          => 'name_title_block_footer',
      //   'label'       => 'Название блока',
      //   'desc'        => 'например: Контакты',
      //   'std'         => '',
      //   'type'        => 'text',
      //   'section'     => 'footer',
      // ),  
      // array(
      //   'id'          => 'name_description_block_footer',
      //   'label'       => 'текст в подвале справа',
      //   'desc'        => 'Например: Свяжитесь с нами любым удобным способом',
      //   'std'         => '',
      //   'type'        => 'text',
      //   'section'     => 'footer',
      // ),
